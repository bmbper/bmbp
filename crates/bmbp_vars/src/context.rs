use crate::{
    BMBP_APP_COPY_WRITE, BMBP_APP_EMAIL, BMBP_APP_GROUP_NAME, BMBP_APP_ICON, BMBP_APP_LOGIN_NAME,
    BMBP_APP_NAME, BMBP_APP_SHORT_NAME, BMBP_APP_TITLE, BMBP_APP_VERSION,
};
