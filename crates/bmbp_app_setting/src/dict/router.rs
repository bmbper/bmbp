...
pub fn build_dict_router() -> Router {
    ...
    dict_router = dict_router
        ...
        .push(Router::with_path("combo/crates/<crates>").post(find_combo_by_code))
        ...
        .push(Router::with_path("cascade/combo/crates/<crates>").post(find_cascade_combo_by_code))
        ...
        .push(Router::with_path("translate/crates/<crates>").post(find_translate_by_code))
        ...
        .push(
            Router::with_path("cascade/translate/crates/<crates>")
        ...
        .push(Router::with_path("multi/combo/crates").post(find_multi_combo_by_code))
        ...
        .push(
            Router::with_path("multi/cascade/combo/crates").post(find_multi_cascade_combo_by_code),
        )
        ...
        .push(Router::with_path("multi/translate/crates").post(find_multi_translate_by_code))
        ...
        .push(
            Router::with_path("multi/cascade/translate/crates")
