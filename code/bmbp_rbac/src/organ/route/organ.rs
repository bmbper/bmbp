...
) -> BmbpResp<RespVo<PageInner<BmbpRbacOrgan>>> {
    tracing::info!("组织机构列表-查询分页");
    let page_inner = OrganService::find_organ_page(&mut params).await?;
    let resp = RespVo::<PageInner<BmbpRbacOrgan>>::ok_data(page_inner);
    Ok(resp)
}
...
pub async fn find_organ_list(
    ...
    let resp = RespVo::<Vec<BmbpRbacOrgan>>::ok_option(organ_tree_data);
    Ok(resp)
}

/// 查询组织
pub async fn find_organ_info(Path(r_id): Path<String>) -> BmbpResp<RespVo<Option<BmbpRbacOrgan>>> {
...
pub async fn save_organ(Json(mut organ): Json<BmbpRbacOrgan>) -> BmbpResp<RespVo<BmbpRbacOrgan>> {
    ...
    let resp = RespVo::<BmbpRbacOrgan>::ok_data(organ_data);
    Ok(resp)
}

/// 新增组织
pub async fn insert_organ(Json(organ): Json<BmbpRbacOrgan>) -> BmbpResp<RespVo<BmbpRbacOrgan>> {
    tracing::info!("{:#?}", organ);
    let resp = RespVo::<BmbpRbacOrgan>::default();
    Ok(resp)
}

/// 更新组织
pub async fn update_organ(Json(organ): Json<BmbpRbacOrgan>) -> BmbpResp<RespVo<BmbpRbacOrgan>> {
    tracing::info!("{:#?}", organ);
    let resp = RespVo::<BmbpRbacOrgan>::default();
    Ok(resp)
}
...
/// 修改组织上级
pub async fn change_organ_parent(Json(param): Json<OrganQueryParam>) -> BmbpResp<RespVo<usize>> {
    tracing::info!("修改组织上级");
