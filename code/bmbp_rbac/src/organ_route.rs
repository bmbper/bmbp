use bmbp_types::{err, BmbpError, BmbpResp, RespVo};
...
pub async fn find_organ_tree_start_with_id() -> BmbpResp<RespVo<Vec<BmbpRbacOrgan>>> {
    err!(BmbpError::api("接口未实现".to_string()))
}

pub async fn find_organ_tree_start_with_code() -> BmbpResp<RespVo<Vec<BmbpRbacOrgan>>> {
    err!(BmbpError::api("接口未实现".to_string()))
}

pub async fn find_organ_tree_start_with_parent() -> BmbpResp<RespVo<Vec<BmbpRbacOrgan>>> {
    err!(BmbpError::api("接口未实现".to_string()))
}
...
pub async fn save_organ() -> BmbpResp<RespVo<Vec<BmbpRbacOrgan>>> {
    err!(BmbpError::api("接口未实现".to_string()))
}
