...
pub fn organ_router() -> Router {
    Router::new()
        .route("/find/tree", post(find_organ_tree).get(find_organ_tree))
        .route(
            "/find/tree/id/:id",
        ...
        .route("/find/list", post(find_organ_list).get(find_organ_list))
        .route(
            "/find/list/parent/:parent",
            post(find_organ_list_by_parent).get(find_organ_list_by_parent),
        )
        .route(
            "/find/info/id/:id",
            post(find_organ_info_by_id).get(find_organ_info_by_id),
        )
        .route(
            "/find/info/code/:organ_code",
            post(find_organ_info_by_code).get(find_organ_info_by_code),
        )
        ...
        .route("/remove", post(remove_organ))
